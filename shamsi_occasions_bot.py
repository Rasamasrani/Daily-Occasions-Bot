...
Data source
-----------
Occasions/holidays are pulled from holidayapi.ir, a free public API that
serves Persian-calendar events scraped from time.ir:
...
HOLIDAY_API_URL = "https://holidayapi.ir/jalali/{year}/{month}/{day}"
...
def fetch_occasions(jdate: jdatetime.date, timeout: int = 15) -> dict:
    """
    Fetch today's occasions from holidayapi.ir for the given Shamsi date.
    ...
    """
    url = HOLIDAY_API_URL.format(year=jdate.year, month=jdate.month, day=jdate.day)
